...
function Herosection() {
  return (
    ...
    <div className='flex flex-col items-center pt-64 h-fit text-center px-4 lg:px-40 gap-5 relative'>
      ...
      <h1 className='text-[2.2rem] lg:text-[4.5rem] w-[200px] lg:w-full font-medium lg:font-semibold text-primaryTextColor '>Get <span className='hero-text'>NEAR</span> Certified!</h1>
